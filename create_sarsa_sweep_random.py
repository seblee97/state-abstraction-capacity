...
# Sweep parameters — larger n_steps and slower eps_decay for sparse reward
lrs = [0.00003, 0.0001, 0.0003]
eps_decays = [0.9999, 0.9997, 0.9995]
n_steps_list = [20, 50, 100]
...
for lr, eps_decay, ns in itertools.product(lrs, eps_decays, n_steps_list):
    ...
    with open(job_path, "w") as f:
        ...
        f.write(f"#SBATCH --job-name=rnd_lr{lr}_ed{eps_decay}_ns{ns}\n")
        ...
        f.write(
            ...
            f" -map_yaml meister_trimmed.yaml"
