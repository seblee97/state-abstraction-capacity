...
for lr, lam, scale in itertools.product(lrs, lambdas, shaping_scales):
    config = {
    ...
    with open(job_path, "w") as f:
        ...
        f.write(f"#SBATCH --job-name=potential_lr{lr}_lam{lam}_s{scale}\n")
