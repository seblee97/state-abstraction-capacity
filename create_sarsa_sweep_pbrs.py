...
for lr, eps_decay, ns, scale in itertools.product(lrs, eps_decays, n_steps_list, shaping_scales):
    config = {
    ...
    with open(job_path, "w") as f:
        ...
        f.write(f"#SBATCH --job-name=pbrs_lr{lr}_ed{eps_decay}_ns{ns}_s{scale}\n")
